 ...
 * This file contains code implementing Algorithm 4.15 from
 ...
 *
 * -------------------------------------------------------------------
 * Generalized fractal, parallelized with OpenMP, master-worker style
